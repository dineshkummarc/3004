...
public class EmailService {
   ...
   /**
     ...
     */
    public EmailService(String user, String receiever, String role, String poll, String useless){
    ...
    private String contentGenerator(String type){
      ...
      if(type.equals("role")){
      //This is for role changed.
          content += "Your role in " + this.poll + " has been changed to " + this.role
                  + ".\n\n"
  ...
  public static void main(String[] args) throws Exception {
     ...
     new EmailService("Andy", "s0956626962@hotmail.com", "Poll User", "pollName", "").send();
