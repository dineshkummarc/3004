...
INSERT into Polls(pollID, pollName, location, description, startDate, finishDate) values (pseq.nextval, 'Bacic Mathematics2', '-27.474074, 152.995286', 'Simple test to work out the mathemtical skill level of students.', to_date('2009/08/12 12:00:00', 'yyyy-mm-dd HH24:MI:SS'), to_date('2010/08/12 12:00:00', 'yyyy-mm-dd HH24:MI:SS'));
...
INSERT into Polls(pollID, pollName, location, description, startDate, finishDate) values (pseq.nextval, 'Basci Mathematics', 'New York', 'Simple test to work out the mathemtical skill level of students.', TO_DATE('2012-02-18 06:42:21', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2013-03-21 23:42:21', 'YYYY-MM-DD HH24:MI:SS'));
