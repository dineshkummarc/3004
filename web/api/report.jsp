...
<%
    ...
    if(type.equals("system")){
        ...
        //}
        response.sendRedirect("/dbPoll/reports/System Utilisation.pdf");
    }
         ...
         //while(Status==""){
          //  out.println("exporting.");
         //}
         response.sendRedirect("/dbPoll/reports/Session History Report.pdf");
    }
    else if(type.equals("session_p")){
        int pollID = Integer.parseInt(request.getParameter("pollID"));
        Status = new ReportService(type, new BigDecimal(pollID)).generateReport();
         //while(Status==""){
          //  out.println("exporting.");
         //}
        response.sendRedirect("/dbPoll/reports/Statistical Report.pdf");
    }
