...
-- Users
INSERT into Users(userID, userName, password, email, location, role) values (1, 'aidan', 'password1', 'aidanrowe@gmail.com', '(-27.522299, 153.047111)', 'Poll Creator');
INSERT into Users(userID, userName, password, email, location, role) values (2, 'stuart', 'pass', 'stuartwsemple@gmail.com', '(-27.570477, 152.841729)', 'Poll Creator');
INSERT into Users(userID, userName, password, email, location, role) values (3, 'darren', 'test', 'darren.goodair@gmail.com', '(-27.53722, 153.078308)', 'Poll Creator');
INSERT into Users(userID, userName, password, email, location, role) values (4, 'david', 'p4ss', 'd.fairbrother@uq.edu.au', '(-27.53722, 153.078308)', 'Poll Creator');
INSERT into Users(userID, userName, password, email, location, role) values (5, 'louis', 'p00', 'louisstow@gmail.com', '(-27.474074, 152.995286)', 'Poll Creator');
INSERT into Users(userID, userName, password, email, location, role) values (6, 'andy', 'poo', 's0956626962@hotmail.com', '(-27.498831257455244, 152.9725170135498)', 'Poll Creator');
...
INSERT into Questions(questID, demographic, responseType, question, pollID, created, creator) values (2, 'F', 'M', 'What\'s your favourite colour?', 1, SYSDATE, 1);
